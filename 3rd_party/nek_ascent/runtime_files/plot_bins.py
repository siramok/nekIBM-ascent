...
plt.xlabel('Z axis')
plt.ylabel('Values')
plt.title(f'Plot of velocity magnitude along the Z axis for timestep {timestep}')
plt.legend()
plt.grid(True)
...
# Save the plot to disk
output_path = f'binned_avg_velocity_magnitude_{num_points}_points_{timestep}_step.png'
plt.savefig(output_path)